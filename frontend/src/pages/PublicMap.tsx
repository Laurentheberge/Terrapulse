  ...
  return (
    <div className="leaflet-top leaflet-right" style={{ marginTop: 10, marginRight: 10 }}>
      <button
        ...
        className="bg-white dark:bg-gray-800 w-9 h-9 flex items-center justify-center rounded-lg shadow-md border border-gray-200 dark:border-gray-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors active:scale-90"
